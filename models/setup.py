...
class ConstructData:
    ...
    def setup_data_structure():
        ...
        megneto = Character(name='Megneto', type='villain', theme='xmen', taken=False)
        ...
        gerneralblight = Character(name='Gerneral Blight', type='villain', theme='bananaman', taken=False)
